...
const output=new URL('../../docs/qa/final/',import.meta.url);
...
try {
 ...
 check('Four featured repositories',await page.locator('#featured-work .project-card').count()===4);
